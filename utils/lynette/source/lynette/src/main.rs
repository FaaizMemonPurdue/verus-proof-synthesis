...
use crate::assert_transform::TransformContext;
...
struct AssertTransform {
    ...
    output: PathBuf,
    #[clap(short, long, help = "Output file for metadata about assert transformed code")]
    metadata: PathBuf,
...
fn main() {
    ...
    match args.command {
        ...
        Commands::AssertTransform(args) => {
            do_assert_transform_file(&args.input, &args.output, &args.metadata, &mut TransformContext {
