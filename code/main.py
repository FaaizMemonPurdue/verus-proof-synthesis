...
def main():
    ...
    parser.add_argument("--basline-with-searhorn", action="store_true", help="Use the seahorn static analysis tool.")
    parser.add_argument(
    ...
    parser.add_argument("--with-crux", action="store_true", help="Use crucible for refinement")
    parser.add_argument("--annotated", action="store_true", help="Use annotated code with specs as comments for one-shot learning")
    parser.add_argument("--rust-only", action="store_true", help="Extract only Rust functions without refinement")
    parser.add_argument(
